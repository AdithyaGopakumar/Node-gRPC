...
goog.exportSymbol('proto.calculator.AvgResponcse', null, global);
/**
 ...
 * @constructor
 */
proto.calculator.AvgResponcse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.calculator.AvgResponcse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.calculator.AvgResponcse.displayName = 'proto.calculator.AvgResponcse';
}
 ...
 * @return {!Object}
 */
proto.calculator.AvgResponcse.prototype.toObject = function(opt_includeInstance) {
  return proto.calculator.AvgResponcse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.calculator.AvgResponcse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.calculator.AvgResponcse.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.calculator.AvgResponcse}
 */
proto.calculator.AvgResponcse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.calculator.AvgResponcse;
  return proto.calculator.AvgResponcse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.calculator.AvgResponcse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.calculator.AvgResponcse}
 */
proto.calculator.AvgResponcse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.calculator.AvgResponcse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.calculator.AvgResponcse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.calculator.AvgResponcse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.calculator.AvgResponcse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getResult();
  if (f !== 0.0) {
    writer.writeDouble(
 ...
 * @return {number}
 */
proto.calculator.AvgResponcse.prototype.getResult = function() {
...
/**
 * @param {number} value
 * @return {!proto.calculator.AvgResponcse} returns this
 */
proto.calculator.AvgResponcse.prototype.setResult = function(value) {
